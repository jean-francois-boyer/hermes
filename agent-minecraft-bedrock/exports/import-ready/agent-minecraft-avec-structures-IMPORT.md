# Import Bedrock — Agent Minecraft Avec Structures

Export généré le : 2026-06-20 18:47

## Fichier principal à importer

- `.mcaddon` : `/opt/data/workspace/agent-minecraft-bedrock/exports/import-ready/agent-minecraft-avec-structures.mcaddon`
- Behavior pack : `/opt/data/workspace/agent-minecraft-bedrock/exports/import-ready/agent-minecraft-avec-structures-behavior.mcpack`
- Resource pack : `/opt/data/workspace/agent-minecraft-bedrock/exports/import-ready/agent-minecraft-avec-structures-resources.mcpack`
